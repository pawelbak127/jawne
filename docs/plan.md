...
| 3a | **Sprawdzić próg z rozporządzenia 651/2014 (GBER)** | `PROG_JAWNOSCI_EUR` (100 tys. EUR) opisujemy w kodzie jako „próg GBER”, ale 24.09.2026 nie udało się otworzyć tekstu rozporządzenia (EUR-Lex oddaje pustą odpowiedź). Jeśli rozporządzenie wymaga publikacji dopiero powyżej wyższej kwoty, to w paśmie między progami pokazujemy nazwiska, których prawo publikować nie każe — a na tym opiera się uzasadnienie w teście równowagi. Do sprawdzenia: art. 9 i załącznik III | **do zweryfikowania** |
